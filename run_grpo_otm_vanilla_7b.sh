...
# 正式实验: Vanilla GRPO on OpenThoughts-Math (OTM) — Qwen2.5-Math-7B
...
export WANDB_PROJECT="grpo_otm_vanilla_7b"
export WANDB_EXP="${WANDB_EXP:-otm_vanilla_7b_$(date +%Y%m%d_%H%M)}"
...
$VERL_PYTHON -m verl.trainer.main_ppo \
    ...
    trainer.rollout_data_dir=/export/home/zhaolei/laiminzhi/rollout_data_otm_vanilla_7b \
