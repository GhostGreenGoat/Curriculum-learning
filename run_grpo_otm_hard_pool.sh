...
# 正式实验: Hard Pool GRPO on OpenThoughts-Math (OTM)
...
export WANDB_PROJECT="grpo_otm_hard_pool"
export WANDB_EXP="${WANDB_EXP:-otm_hardpool_$(date +%Y%m%d_%H%M)}"
...
$VERL_PYTHON -m verl.trainer.main_ppo \
    ...
    trainer.rollout_data_dir=/export/home/zhaolei/laiminzhi/rollout_data_otm_hard_pool \
